      ...
      <section>
        ...
        <section className="flex justify-center">
          <div className="border border-gray-200/30 w-[70vw] p-10 relative">
            <p className="text-xs text-green-400 absolute top-2">
              2023-Present
            </p>
            <p>
              <span className="text-green-400">Graduation: </span>Computer
              Science
            </p>
            <p>
        ...
        <section className="flex justify-center">
          <div className="border border-gray-200/30 w-[70vw] p-10 relative">
            ...
            <p>
              <span className="text-green-400">School: </span> Senai /
              DevInHouse
            </p>
            <p>
            ...
            <p>
              ...
              SpringBoot, Oracle, Unity Tests, Docker, Software Architecture,
              Git
            </p>
          </div>
        </section>
        ...
        <section className="flex justify-center">
          <div className="border border-gray-200/30 w-[70vw] p-10 relative">
            ...
            <p>
              <span className="text-green-400">School: </span> Universidade do
        ...
        <section className="flex justify-center">
          <div className="border border-gray-200/30 w-[70vw] p-10 relative">
            ...
            <p>
              ...
              acquiring initial experience as a programmer while also working as
              a physiotherapist, I am now fully committed to my career in
        ...
        <section className="flex justify-center">
          <div className="border border-gray-200/30 w-[70vw] p-10 relative">
            ...
            <p>
              ...
              practice the skills I had acquired at university. In addition,
              this experience provided me with the development of soft skills,
              such as sales, effective communication, empathy, and direct
        ...
        <section className="flex justify-center">
          <div className="border border-gray-200/30 w-[70vw] p-10 relative">
            ...
            <p>
              ...
              was to create personalized treatment and training plans,
              considering the physical capacity, goals, and comorbidities of
              each client. During the sessions, I attended 2 to 6 people
              simultaneously, developing dynamism, observation skills, and
